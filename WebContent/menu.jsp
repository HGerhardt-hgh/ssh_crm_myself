...
<TR> 
	<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/customer_normalList.action"
		target=main>－ 客户列表</A></TD>
</TR>
<TR> 
	<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/customer_list?currentPage=1"
								...
								<TR>
									<TD>
										<TABLE id=table_3 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="customer_showFind.action"
														target=main>－ 客户信息查询</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="linkMan_showFind.action"
														target=main>－ 联系人信息查询</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="visit_showFind.action"
								...
								<TR>
									<TD>
										<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="customer_countByName"
														target=main>－客户名称统计</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="customer_countByLevel"
								...
								<TR>
									<TD>
										<TABLE id=table_6 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="customer_custLevel"
														target=main>－客户级别管理</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="user_showMaG.action?uid=${user.uid }"
